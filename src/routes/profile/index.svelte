...
<script lang="ts">
  ...
  // import type { User as IUser } from "../../backend/interfaces/User";
  // import type { Alert as IAlert } from "../../backend/interfaces/Alert";
  // import type { Location as ILocatiion } from "../../backend/interfaces/Location";
  ...
  // import Nav from "../../frontend/components/Nav.svelte";
